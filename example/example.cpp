...
void rangeExamples() {
    ...
    for (int64_t value : range(2, 11, 3)) {
        std::cout << "(" << value << ")";
    }
...
void enumerateExamples() {
    ...
    for (auto&& [index, value] : enumerate{ vec, 10 }) {
        std::cout << "(" << index << "," << value << ")";
    }
    std::cout << std::endl;
    ...
    std::cout << "Should print (0,1)(1,2)(2,3)" << std::endl << "             ";
    for (auto&& [index, value] : enumerate{ get_vec() }) {
        std::cout << "(" << index << "," << value << ")";
    }
    std::cout << std::endl << std::endl;
}
...
void zipExamples() {
    ...
    for (auto&& [vec1_val, vec2_val, arr_val] : zip{ vec1, vec2, arr }) {
    ...
    for (auto&& [vec1_val, vec2_val, list1_val] : zip{ vec1, vec2, list1 }) {
    ...
    for (auto&& [vec1_val, vec2_val, arr_val] : zip{ vec1, get_vec(), arr }) {
        std::cout << "(" << vec1_val << "," << vec2_val << "," << arr_val << ")";
    }
    std::cout << std::endl;
    ...
    for (auto&& [vec1_val, vec2_val, arr_val] : zip{ vec1, get_short_vec(), arr }) {
        std::cout << "(" << vec1_val << "," << vec2_val << "," << arr_val << ")";
    }
    std::cout << std::endl << std::endl;
}
